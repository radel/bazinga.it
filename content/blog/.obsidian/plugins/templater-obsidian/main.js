...
function mapToStyles(_ref2) {
  ...
  if (gpuAcceleration) {
    var _Object$assign;
    return Object.assign({}, commonStyles, (_Object$assign = {}, _Object$assign[sideY] = hasY ? "0" : "", _Object$assign[sideX] = hasX ? "0" : "", _Object$assign.transform = (win.devicePixelRatio || 1) <= 1 ? "tranzinc(" + x + "px, " + y + "px)" : "tranzinc3d(" + x + "px, " + y + "px, 0)", _Object$assign));
  }
